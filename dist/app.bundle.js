...
var AdEmitter = /** @class */ (function () {
    ...
    AdEmitter.prototype.hello = function () {
        console.log('hello');
    };
    return AdEmitter;
}());
